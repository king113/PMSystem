	...
	/*window.location.href="ad_indexlph?city="+$(".cities").val();*/
										...
										<div>
											<h1>
												...
												<small><span class="label label-warning"
													style="width: 80px;">${pp.quality }</span>
												</small>
											</h1>
										</div>
									</div>
			...
			<div id="tabBox1" class="tabBox" style="height: auto;">
				<div class="hd">
					<ul>
						<li>
							<span><img src="image/hot.png" />
							</span>
							<a href="javascript:void(0)">实时监测</a>
						</li>
						<li>
							<span><img src="image/news.png" />
							</span>
							<a href="javascript:void(0)">历史信息</a>
						</li>
						<li>
							<span><img src="image/shop.png" />
							</span>
							<a href="javascript:void(0)">生活帮手</a>
						</li>
						<li>
							<span><img src="image/fan.png" />
							</span>
						...
						<ul class="rest">
							...
							<li>
								<div class="content-head">
									...
									<span class="head-name">保护环境</span>
									<span class="zan"> <img class="zans"
											src="image/zans.png" /> <i></i> <a>25</a> </span>
								</div>
								<div class="con-detail">
	...
	TouchSlide({
		...
		endFun : function(i) { //高度自适应
			...
			<div class="footer">
				...
				<a href="#"> <span><img src="image/map.png" />
				</span> <span>站点信息</span> </a>
				<a href="#"> <span><img src="image/pai.png" />
				</span> <span>排行榜</span> </a>
				<a href="#"> <span><img src="image/my.png" />
				</span> <span>关于我们</span> </a>
			</div>
			<!--footer end-->
